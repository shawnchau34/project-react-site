...
const activities = [
    { name: "Heritage Line Ylang Cruise", image: "project-react-site/images/cruise.jpg", description: "A luxury cruise through Ha Long Bay.", link: "https://www.example.com/cruise" },
    { name: "The Marble Mountains", image: "project-react-site/images/mm.jpg", description: "A cluster of marble and limestone hills in Da Nang.", link: "https://www.example.com/marble_mountains" },
    { name: "Cat Ba Island", image: "project-react-site/images/island.jpg", description: "A serene island with breathtaking landscapes.", link: "https://www.example.com/cat_ba_island" },
    { name: "The Old Quarter", image: "project-react-site/images/quarter.jpg", description: "A historic area in Hanoi, known for its bustling markets.", link: "https://www.example.com/old_quarter" }
];
