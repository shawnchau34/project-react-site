...
const munchies = [
    { name: "Bánh mì", image: "project-react-site/images/banhmi.jpg", description: "A popular Vietnamese sandwich.", link: "https://en.wikipedia.org/wiki/Bánh_mì" },
    { name: "Phở", image: "project-react-site/images/pho.jpg", description: "A fragrant noodle soup.", link: "https://en.wikipedia.org/wiki/Phở" },
    { name: "Bún bò Huế", image: "project-react-site/images/bbh.jpg", description: "A spicy beef noodle soup.", link: "https://en.wikipedia.org/wiki/Bún_bò_Huế" },
    { name: "Bún thịt nướng", image: "project-react-site/images/btn.jpg", description: "Grilled pork with vermicelli.", link: "https://en.wikipedia.org/wiki/Bún_thịt_nướng" }
];
